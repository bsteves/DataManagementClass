...
```{r import_csv}
    csv_speed<-system.time(data<-read.csv("C:/Users/stevesb/Downloads/5m Sales Records.csv"))
    print(csv_speed)
...
```{r open_binary}
save(data, file="data/5m_Sales_Records.Rdata")
binary_speed<-system.time(load(file="data/5m_Sales_Records.Rdata"))
print(binary_speed)
