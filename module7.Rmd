...
Module 7: More fun with Dplyr and Tidyr
====================
...
Using dplyr, write an R script that imports your data and then manipulate that data using the filter(), group_by(), select(), arrange() and summarize() functions.   If you have two related tables that you can join, try that as well.

Upload the R file to the module's dropbox.
